@echo off
REM ================================================================
REM  RP2040 System Build / Flash Script (v2.7.1)
REM
REM  Usage:
...
set "UF2=%BUILD_DIR%\rp2040system.uf2"
...
REM -------- Start log --------
>  "%LOG%" echo ================================================================
>> "%LOG%" echo RP2040 System Build Run - %date% %time%
...
:RUN_CMAKE_CONFIG
>> "%LOG%" echo [CMAKE CONFIG] Configuring RP2040 System...
cd /d "%BUILD_DIR%"
...
:RUN_CMAKE_BUILD
>> "%LOG%" echo [CMAKE BUILD] Building RP2040 System...
cd /d "%BUILD_DIR%"
"%NINJA_BIN%\ninja.exe" rp2040system >> "%LOG%" 2>&1
exit /b %errorlevel%